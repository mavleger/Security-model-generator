...
export const googleRoutes = [
    {
        path: `/${providerType}/drive/folder`,
        name: `${providerType}Folder`,
        component: () => import(/* webpackChunkName: "folder-access" */ '../views/google/DriveAccess.vue')
    },
    {
        path: `/${providerType}/:provider/:folder/threatmodels`,
        name: `${providerType}ThreatModelSelect`,
        component: () => import(/* webpackChunkName: "threatmodel-select" */ '../views/google/ThreatModelSelect.vue')
    },
    {
    ...
    {
        path: `/${providerType}/drive/:folder/new`,
